        ...
        {user ? (
          <>
            ...
            <div className="flex items-center gap-3 border-l border-gray-200 pl-4">
              ...
              <button
                onClick={signOut}
                className="flex items-center gap-1.5 rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-xs font-semibold text-gray-700 shadow-xs hover:bg-gray-50 transition"
              >
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="rounded-lg px-3.5 py-1.5 text-sm font-semibold text-gray-700 hover:bg-gray-100 transition"
            >
              Sign In
            </Link>
            <Link
              href="/register"
              className="rounded-lg bg-blue-600 px-3.5 py-1.5 text-sm font-semibold text-white shadow-xs hover:bg-blue-700 transition"
            >
              Get Started
            </Link>
          </div>
