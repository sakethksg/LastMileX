          ...
          <div className="flex flex-wrap items-center gap-3">
            {isAssignable && (
              <>
                ...
                <button
                  ...
                  className="btn-product-terraform text-xs !py-2"
                >
            ...
            {order.status === OrderStatus.FAILED && order.currentAttempt < (order.maxAttempts || 3) && (
              <button
                ...
                className="btn-secondary !border-amber-200/50 !text-amber-200 text-xs !py-2"
              >
        ...
        <form onSubmit={handleManualAssign} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2 border-t border-hairline-soft">
            ...
            <button
              ...
              aria-busy={actionLoading}
              className="btn-product-terraform !px-4 !py-2 text-xs"
            >
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <section aria-label="Routing and assignment" className="card-surface-1 space-y-4">
            ...
            {assignedAgent ? (
              <div className="mt-4 flex items-center gap-3 border-t border-hairline-soft pt-4 bg-surface-2 p-3 rounded-md border border-hairline">
                <div className="flex h-10 w-10 items-center justify-center rounded-md bg-surface-3 text-product-terraform-bright font-bold">
                  <User className="h-5 w-5" aria-hidden="true" />
                </div>
                <div>
                  <div className="text-eyebrow font-semibold uppercase text-product-terraform-bright">Currently Assigned Driver</div>
              ...
              <div className="text-xs text-product-vault bg-surface-2 p-3 rounded-md border border-product-vault/30 font-mono">
          ...
          <section aria-label="Tracking state audit" className="card-surface-1 space-y-4">
            <h2 className="text-base font-bold text-ink flex items-center gap-2">
              <Clock className="h-5 w-5 text-product-terraform-bright" aria-hidden="true" />
            ...
            <div className="relative pl-6 space-y-5 before:absolute before:left-2.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-hairline">
              {trackingEvents.map((event: any) => (
                <div key={event.id} className="relative">
                  <div className="absolute -left-6 top-1.5 h-3.5 w-3.5 rounded-full border-2 border-surface-1 bg-product-terraform-bright shadow-xs" aria-hidden="true" />
